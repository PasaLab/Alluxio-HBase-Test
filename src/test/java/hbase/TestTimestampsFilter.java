...
public class TestTimestampsFilter {
  ...
  public void testTimestampsFilter() throws Exception {
    ...
    Table ht = util.createTable(TableName.valueOf(TABLE), FAMILIES, Integer.MAX_VALUE);
    ...
    util.getAdmin().flush(TableName.valueOf(TABLE));
  ...
  public void testMultiColumns() throws Exception {
    ...
    p.addColumn(FAMILY, Bytes.toBytes("column0"), 3, Bytes.toBytes("value0-3"));
    p.addColumn(FAMILY, Bytes.toBytes("column1"), 3, Bytes.toBytes("value1-3"));
    p.addColumn(FAMILY, Bytes.toBytes("column2"), 1, Bytes.toBytes("value2-1"));
    p.addColumn(FAMILY, Bytes.toBytes("column2"), 2, Bytes.toBytes("value2-2"));
    p.addColumn(FAMILY, Bytes.toBytes("column2"), 3, Bytes.toBytes("value2-3"));
    p.addColumn(FAMILY, Bytes.toBytes("column3"), 2, Bytes.toBytes("value3-2"));
    p.addColumn(FAMILY, Bytes.toBytes("column4"), 1, Bytes.toBytes("value4-1"));
    p.addColumn(FAMILY, Bytes.toBytes("column4"), 2, Bytes.toBytes("value4-2"));
    p.addColumn(FAMILY, Bytes.toBytes("column4"), 3, Bytes.toBytes("value4-3"));
    ht.put(p);
